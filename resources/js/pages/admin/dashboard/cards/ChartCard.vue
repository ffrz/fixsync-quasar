<template>
  <div class="row q-col-gutter-sm">
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card square class="no-shadow" bordered style="background-color: #38b1c5">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card square class="no-shadow" bordered style="background-color: #ea4b64">
        <q-card-section class="text-h6 text-white">
          Daily Sales
        </q-card-section>
        <q-card-section class="q-pa-none">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card square class="no-shadow" bordered style="background-color: #1e88e5">
        <q-card-section class="text-h6 text-white">
          Today's User Visit
        </q-card-section>
        <q-card-section class="q-pa-none">
