...
const fetchItems = (props = null) => {
  handleFetchItems({
    ...
    props,
    rows,
    url: route("admin.technician.data"),
    loading,
  });
};
  ...
  <authenticated-layout>
    ...
    <template #right-button>
      <q-btn
        ...
        dense
        color="primary"
        @click="router.get(route('admin.technician.add'))"
      />
      <q-btn
        class="q-ml-sm"
                  ...
                  >
                    <q-list style="width: 200px">
                      <q-item
                        ...
                        v-ripple
                        v-close-popup
                        @click.stop="router.get(route('admin.technician.duplicate', props.row.id))"
                      >
                      ...
                      <q-item
                        ...
                        v-ripple
                        v-close-popup
                        @click.stop="router.get(route('admin.technician.edit', props.row.id))"
                      >
                        <q-item-section avatar>
                          <q-icon name="edit" />
                        </q-item-section>
